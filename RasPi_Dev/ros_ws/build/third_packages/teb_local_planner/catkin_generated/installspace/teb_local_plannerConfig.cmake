...
if(NOT "include;/usr/include/suitesparse;/home/xtark/Software/libg2o-release/g2o/;/home/xtark/Software/libg2o-release " STREQUAL " ")
  set(teb_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/suitesparse;/home/xtark/Software/libg2o-release/g2o/;/home/xtark/Software/libg2o-release")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teb_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xtark/ros_ws/install/${idir}'.  ${_report}")
    endif()
