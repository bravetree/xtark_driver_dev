...
(cl:in-package xtark_line_follower-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <pos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xtark_line_follower-msg:<pos> is deprecated: use xtark_line_follower-msg:pos instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xtark_line_follower-msg:direction-val is deprecated.  Use xtark_line_follower-msg:direction instead.")
  (direction m))
