...
set(MSG_I_FLAGS "-Ixtark_line_follower:/home/xtark/ros_ws/src/xtark_cv/xtark_line_follower/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/xtark/ros_ws/src/xtark_cv/xtark_line_follower/msg/pos.msg" NAME_WE)
add_custom_target(_xtark_line_follower_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xtark_line_follower" "/home/xtark/ros_ws/src/xtark_cv/xtark_line_follower/msg/pos.msg" ""
)
...
_generate_msg_cpp(xtark_line_follower
  "/home/xtark/ros_ws/src/xtark_cv/xtark_line_follower/msg/pos.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xtark_line_follower)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xtark_line_follower/.+/__init__.pyc?$"
  )
endif()
